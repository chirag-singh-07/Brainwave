...
import heroIcons from "../constants/heroIcons.js";
  ...
  return (
    ...
    >
      <div className="container relative " ref={parallaxRef}>
        <div
          className="relative z-1 max-[62rem] mx-auto text-center mb-[4rem]
        md:mb-20 lg:md-[6rem]"
        >
          <h1 className="h1 mb-6">
            Explore the Possibilities <br /> of AI Chatting with{" "}
            <span className="inlline-block relative">
              Brainwave{" "}
              <img
                src={curve}
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            ...
            with Brainwave, the opne AI chat app
          </p>
          <Button href="/pricing" white className="pt-3">
            Get started
          </Button>
        </div>
            ...
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <div className="hidden lg:block">
                  <Generating
                    className="absolute left-4 right-4 buttom-5 md:left-1/2 md:right-auto
                md:bottom-8 md: w-[31rem] md:-translate-x-1/2 border border-n-1/15"
                  />
                </div>
                <ScrollParallax isAbsolutelyPositioned>
                  <ul
                    className="hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1
                  py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl 
                  xl:flex"
                  >
