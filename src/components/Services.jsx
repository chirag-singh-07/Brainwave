...
} from "../constants/brainwaveServices";
    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlocks the protential of AI-powered applications"
        />
        <div className="relative">
          <div
            className="relative flex items-center h-[39rem] mb-5 p-8 border
          ...
          >
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Brainwave unlocks the protential of AI-powered applications
              </p>
              <ul className="body-2">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden ">
              ...
              p-8 bg-gradient-to-b from-n-8/10 to-n-8/90 lg:p-15"
              >
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 lg:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  ...
                  generation engine. what will create?{" "}
                </p>
